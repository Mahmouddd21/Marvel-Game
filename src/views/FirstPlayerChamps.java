...
public class FirstPlayerChamps {

    public FirstPlayerChamps(JFrame frame) throws IOException {
        ...
        JLabel label = new JLabel(NameSelect.game.getFirstPlayer().getName() + " CHOOSE YOUR CHAMPIONS");
        ...
        team.setBackground(Color.cyan);
        team.setBorder(border);
        team.setEditable(false);


        //to move onto next panel
        ...
        for (int i = 0; i < champions.size(); i++) {
            ...
            button.addActionListener(e -> {
                if (firstPlayerChamps.size() < 3 && !firstPlayerChamps.contains(champ)) {
                    ...
                    String s1 = NameSelect.game.getFirstPlayer().getName() + "'s team: " + firstPlayerChamps.toString();
            ...
            NameSelect.game.getFirstPlayer().setTeam(firstPlayerChamps);
